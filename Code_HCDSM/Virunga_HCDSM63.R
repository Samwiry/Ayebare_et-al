...
name= c("Buteo oreophilus", "Halcyon chelicuti", "Pogoniulus bilineatus", "Pogoniulus coryphaeus", "Trachylaemus purpuratus",
        ...
        "Malaconotus dohertyi", "Merops oreobates", "Batis diops","Batis molitor","Melaenornis fisheri","Bradornis comitatus",
        "Terpsiphone viridis", "Ruwenzorornis johnstoni", "Tauraco schuetti","Cinnyris regius", "Cinnyris stuhlmanni","Cinnyris venustus",
        "Cyanomitra alinae", "Hedydipna collaris", "Nectarinia johnstoni", "Oriolus percivali", "Parus fasciiventer", "Ploceus alienus",
