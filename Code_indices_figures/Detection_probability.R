...
## Detection_probability.r
        ## This script generates:
                      #  Appendix S4:Figure S1. Community mean detection probabilities 
#------------------------------------------------------------------------------------------------##
#------------------------------------------------------------------------------------------------##
...
Figure5 + labs (x="Distance(m)", y ="Detection probability", color = "Legend\n",fontface= "bold") +
...
ggsave(file = "Figure5_detection_probability.jpg", bg = NULL, dpi = 300, width = 15, height = 10)
